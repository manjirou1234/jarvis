...
def funtion():
	speak("I can perform various features such as Access to the internet, search Wikipedia, tell the current time and date, search Google, open a video from YouTube, open game, open Google Drive, switch the window and play a music. How can I help you?")
	...
	def brain(self):
		while True:
			...
			if you == "":
				...
				speak(random.choice(RESPONSES))
				break
			elif "goodbye" in you or "shutdown" in you:
