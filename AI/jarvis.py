...
def hear_vie():
	with speech_recognition.Microphone() as mic:
		audio = jarvis_ear.listen(mic, timeout=6, phrase_time_limit=6)
	try:
...
def switch_tab():
	while True:
		...
		try:
			...
			you = ""
		if "stop" in you or "okay" in you:
			pyautogui.keyUp("alt")
			break

def take_screenshot():
	speak("What would you like to name your image sir?")
	while True:
		name = hear_vie()
		if name == "":
			speak("Please tell me the name which you want to set for your image sir!")
		else:
			screenshot = ImageGrab.grab()
			save_screenshot = "C:\\Users\\Phuc Nhat\\Pictures\\Screenshots\\" + name + ".jpg"
			screenshot.save(save_screenshot)
			speak("your screen has been captured sir!")
			break
		
def display_screenshot():
	while True:
		try:
			speak("Which image do you want me to display sir?")
			name = hear_vie()
			...
			speak("Sorry sir! I'm affraid the image you want is unable to display!")
def system_shutdown():
	speak(random.choice(RESPONSES))
...
def taking_selfie():
	...
	if camlist:
		...
		speak("Taking selfie funtion starting in 3 seconds...")
		cam.start()
		speak("3")
		speak("2")
		speak("1")
		img = cam.get_image()
		pygame.image.save(img, "C:\\Users\\Phuc Nhat\\Pictures\\Camera Roll\\me.jpg")
		speak("Your selfie image has been saved successfully! Would you like to check it out sir?")
		you = hear()
		if "yes" in you:
			img = Image.open("C:\\Users\\Phuc Nhat\\Pictures\\Camera Roll\\me.jpg")
			img.show()
			speak(random.choice(RESPONSES))
		else:
			speak(random.choice(RESPONSES))
		...
		print("No camera detected! Failed to activate taking selfie funtion sir!")

def funtion():
	speak("I can help you to Access to the internet, search Wikipedia, tell the current time and date, search Google, open a video from YouTube, open game, open Google Drive, switch the window, take a selfie, capture a screenshot and play a music. How can I help you?")

def greeting():
	speak("I am Jarvis. Online and ready sir! Can you tell me how I may help you?")
...
class JarvisAssistant(QThread):
	...
	def brain(self):
		while True:
			...
			if you == "":
			...
			elif "internet" in you or "website" in you:
				...
				drive_google()
			elif "music" in you or "song" in you:
				play_music()
				break
				...
				switch_tab()
			elif "show me the screenshot" in you or "display" in you:
				display_screenshot()
			elif "take screenshot" in you or "capture" in you or "take a screenshot" in you:
				take_screenshot()
			elif "shutdown" in you:
				system_shutdown()
			elif "restart" in you:
				system_restart()
			elif "selfie" in you or "picture" in you:
				taking_selfie()
			elif "hello" in you:
				greeting()
			elif "what you can do" in you or "help me" in you:
				funtion()
			elif "stop" in you or "rest" in you:
				speak(random.choice(RESPONSES))
				break
			elif "goodbye" in you:
